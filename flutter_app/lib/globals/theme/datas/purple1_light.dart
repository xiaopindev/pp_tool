...
final ThemeData _purple1Light = ThemeData(
  useMaterial3: true,
  primaryColor: const Color(0xFFBE63F6), // 较浅的紫色
  scaffoldBackgroundColor: const Color(0xFFFFFFFF), // 白色背景
  shadowColor: const Color(0xFF2C2C2C),
  colorScheme: ColorScheme.fromSwatch().copyWith(
    primary: const Color(0xFFBE63F6), // 较浅的紫色
  ...
  appBarTheme: const AppBarTheme(
    backgroundColor: Color(0xFFBE63F6), // 背景颜色
  ...
  buttonTheme: const ButtonThemeData(
    buttonColor: Color(0xFFBE63F6), // 高亮背景色
    ...
    style: ButtonStyle(
      backgroundColor: WidgetStateProperty.resolveWith<Color?>(
        (Set<WidgetState> states) {
          ...
          return const Color(0xFFBE63F6); // 高亮背景色
        },
      ),
  ...
  listTileTheme: const ListTileThemeData(
    ...
    selectedColor: Color(0xFFBE63F6), // 选中项颜色
    iconColor: Color(0xFF757575), // 图标颜色
    textColor: Color(0xFF757575), // 文本颜色
    selectedTileColor: Color(0xFFE1BEE7), // 选中项背景颜色
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(8)), // 圆角
      borderSide: BorderSide(color: Color(0xFFBE63F6)), // 聚焦状态下的边框颜色
    ),
