...
final ThemeData _blue1Dark = ThemeData(
  useMaterial3: true,
  primaryColor: const Color(0xFF3FA9EF), // 深色模式下的天蓝色
  scaffoldBackgroundColor: const Color(0xFF10151C), // 深色背景
  shadowColor: const Color(0xFF2C2C2C),
  colorScheme: ColorScheme.fromSwatch().copyWith(
    primary: const Color(0xFF3FA9EF), // 深色模式下的天蓝色
