...
final ThemeData _blue1Light = ThemeData(
  useMaterial3: true,
  primaryColor: const Color(0xFF3FA9EF), // 较浅的天蓝色
  scaffoldBackgroundColor: const Color(0xFFFFFFFF), // 白色背景
  shadowColor: const Color(0xFF2C2C2C),
  colorScheme: ColorScheme.fromSwatch().copyWith(
    primary: const Color(0xFF3FA9EF), // 较浅的天蓝色
  ...
  appBarTheme: const AppBarTheme(
    backgroundColor: Color(0xFF3FA9EF), // 背景颜色
  ...
  buttonTheme: const ButtonThemeData(
    buttonColor: Color(0xFF3FA9EF), // 高亮背景色
    ...
    style: ButtonStyle(
      backgroundColor: WidgetStateProperty.resolveWith<Color?>(
        (Set<WidgetState> states) {
          ...
          return const Color(0xFF3FA9EF); // 高亮背景色
        },
      ),
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(8)), // 圆角
      borderSide: BorderSide(color: Color(0xFF3FA9EF)), // 聚焦状态下的边框颜色
    ),
